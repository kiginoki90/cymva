      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionTitle('第7条（提供の停止・中断）'),
            _buildSectionContent([
              '1.　',
              '当方は以下の場合，本サービスの提供を停止または中断することがあります。',
            ]),
            _buildSectionContent([
              '　（1）',
            ...
            _buildSectionTitle('第9条（退会）'),
            _buildSectionContent([
              '1.　',
              'ユーザーは，当方が定める手続により，自己の事由な石で本サービスを退会又は本アプリのアンインストールをすることができます。ユーザーが本アプリのアンインストールを行った場合、退会したものとみなします。',
            ]),
            _buildSectionContent([
              '2.　',
              '退会により，ユーザーが本アプリに登録した情報は全て削除されます。当方は、退会したユーザーの個人情報等一切の情報を引き続き保管する義務を負わないものとします。',
            ]),
            _buildSectionTitle('第10条（免責事項）'),
            _buildSectionContent([
              '1.　',
            ...
            _buildSectionTitle('第11条（サービス内容の変更等）'),
            _buildSectionContent([
              '1.　',
            ...
            _buildSectionTitle('第12条（個人情報の取扱い）'),
            _buildSectionContent([
              '',
              '当方は，個人情報を「プライバシーポリシー」に従い適切に管理します。',
            ]),
            _buildSectionTitle('第13条（本利用規約の有効性）'),
            _buildSectionContent([
              '1.　',
